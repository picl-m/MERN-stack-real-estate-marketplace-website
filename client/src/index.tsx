        ...
        <Routes>
          ...
          <Route path="search">
            <Route path="houses">
              ...
              <Route
                path="results"
                element={<SearchResults estateType="houses" />}
              />
            </Route>
            <Route path="apartments">
              ...
              <Route
                path="results"
                element={<SearchResults estateType="apartments" />}
              />
            </Route>
            <Route path="land">
              ...
              <Route
                path="results"
                element={<SearchResults estateType="land" />}
              />
            </Route>
          </Route>
          <Route path="create">
            ...
            <Route
              path="apartment"
              element={<CreateForm estateType="apartments" />}
            />
