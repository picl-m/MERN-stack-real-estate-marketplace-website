...
export default function SearchResults(props: HomePageProps) {
  ...
  const estateString =
    ...
    props.estateType.substring(
      1,
      props.estateType !== "land" ? props.estateType.length - 1 : undefined,
    ) +
    " for " +
    currentSearchParams.get("deal");

  const priceString =
    currentSearchParams.get("deal") === "rent" ? " CZK/month" : " CZK";
